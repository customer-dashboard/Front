const ContactNoteResponses = {
  ...
  "properties": {
    ...
    "body": {
      ...
      "examples": [
        "Mrs. Allen is our most important client … because every client is our most important client."
      ]
    },
    "created_at": {
      "type": "number",
  ...
  "title": "ContactNoteResponses",
  "x-readme-ref-name": "ContactNoteResponses"
} as const;
export default ContactNoteResponses
