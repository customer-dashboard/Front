import KnowledgeBaseArticleSlimResponse from './KnowledgeBaseArticleSlimResponse.js';

const ListArticlesInAKnowledgeBase = {
  "metadata": {
    "allOf": [
      {
  ...
  "response": {
    "200": {
      ...
      "properties": {
        ...
        "_results": {
          "type": "array",
          "items": KnowledgeBaseArticleSlimResponse
        }
      },
      "$schema": "http://json-schema.org/draft-04/schema#"
    }
...
export default ListArticlesInAKnowledgeBase
